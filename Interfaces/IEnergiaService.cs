...
namespace ApiEnergia.Interfaces
{
    public interface IEnergiaService
    {
        ...
        /// <summary>
        /// Arma los datos del comprobante de pago en banco para un contador.
        /// </summary>
        Task<ComprobantePagoBancoDto?> ObtenerComprobantePagoPorContadorAsync(string numeroContador);
